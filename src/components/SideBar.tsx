...
const assignHeadingsToLevel = (nextHeading: Element | null, subHeadingElements: Element[][]): HeadingLevel[] => {
...
const SideBarHeadingWrapper: React.FC<{ heading: HeadingLevel, level: SideBarHeadingProps['level'] }> = ({ heading, level }) => {
  return (
    <div>
      <SideBarHeading level={level}>

...
1\. PhageAI (Poland): PhageAI offers an AI-powered platform for in silico characterization of bacteriophages. Their technology reduces the time required to analyze phage genomes from several days to under an hour, facilitating rapid identification of suitable phages for therapeutic applications. (https://phage.directory/, phage.ai)

2\. Locus Biosciences (USA): Locus Biosciences employs machine learning to analyze high-throughput data on phage-bacteria interactions. This approach enables the prediction of effective phage cocktails, enhancing the development of CRISPR-enhanced bacteriophage therapies. (nexabiome.com)
3\. PrecisionPhage (Finland): PrecisionPhage has developed "Phagenomics," a browser-based tool that streamlines phage genome analysis. This platform aids in the rapid assembly and annotation of phage genomes, expediting the discovery of therapeutic phages. (https://phage.directory/)
